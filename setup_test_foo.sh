...
# 2nd service
curl -X POST -H "Content-Type: application/json" -d '{"name": "foo2", "fqdn": "foo2.example.com", "failover_pool_fqdn": "bar:80", "healthcheck_interval": 1000, "dns_resolver": "dnsmasq"}' "http://localhost:5000/service"
