...
curl -X POST -H "Content-Type: application/json" -d '{"name": "foo", "fqdn": "foo.example.com", "failover_pool_fqdn": "baz_lb_ssl:443", "failover_pool_use_https": 1, "failover_pool_ssl_verify_none": 1, "healthcheck_interval": 1000, "dns_resolver": "dnsmasq"}' "http://localhost:5000/service"
